        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600">
              Por favor, lee detenidamente estos términos y condiciones antes de usar
              nuestros servicios.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto prose">
          <section className="mb-12">
            ...
            <p className="text-gray-600">
              Al acceder y utilizar nuestros servicios, aceptas estar sujeto a estos
              términos y condiciones. Si no estás de acuerdo con alguna parte de estos
              términos, no podrás acceder a nuestros servicios.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              Si tienes preguntas sobre estos términos, contáctanos en legal@financeflow.mx
              o llama al (555) 123-4567.
            </p>
          </section>
        </div>
      </div>
