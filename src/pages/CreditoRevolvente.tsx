        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <p className="text-lg text-gray-600 mb-8">
              Nuestro Crédito Revolvente te ofrece la flexibilidad que necesitas para manejar
              tu flujo de efectivo. Dispón de recursos cuando los necesites y paga solo por
              lo que utilizas.
            </p>
          ...
          <div>
            ...
            <div className="bg-primary/5 rounded-xl p-8">
              ...
              <p className="text-gray-600 mb-6">
                Calcula tu línea de crédito y obtén una cotización personalizada en minutos.
              </p>
