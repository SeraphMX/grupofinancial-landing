...
const CreditWizard = () => {
  ...
  const getWhatsappLink = () => {
    const message = encodeURIComponent(
      `¡Hola! Me interesa obtener más información sobre un crédito ${
        clientType === 'personal' ? 'personal' : 'empresarial'
      } ${guaranteeType === 'con-garantia' ? 'con garantía hipotecaria ' : ''}con las siguientes características:\n\n` +
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-gray-600">
                  Créditos personales desde $100,000 hasta $5,000,000 MXN
                </p>
              </button>
              <button
              ...
              >
                ...
                <p className="text-gray-600">
                  Financiamiento empresarial desde $500,000 hasta $10,000,000 MXN
                </p>
              </button>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-bold text-primary">Cotizador de Crédito</h1>
            </div>
          </div>
