        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <p className="text-lg text-gray-600 mb-8">
              El Arrendamiento Financiero es la solución ideal para adquirir activos productivos
              sin descapitalizar tu empresa. Obtén los equipos, vehículos o maquinaria que
              necesitas con beneficios fiscales y financieros.
            </p>
          ...
          <div>
            ...
            <div className="bg-primary/5 rounded-xl p-8">
              ...
              <p className="text-gray-600 mb-6">
                Solicita una cotización personalizada para tu arrendamiento financiero.
              </p>
