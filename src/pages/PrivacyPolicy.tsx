        ...
        <div className='max-w-3xl mx-auto prose'>
          ...
          <section className='mb-12'>
            ...
            <ul className='list-disc pl-6 text-gray-600'>
              ...
              <li>
                Socios comerciales con quien se tengan celebrados contratos para la comercialización de productos y/o servicios financieros,
            ...
            <p className='text-gray-600 mt-4'>
              En cualquier caso, GRUPO FINANCIAL comunicará a los receptores, el presente Aviso de Privacidad, con el fin de asegurar que su
          ...
          <section className='mb-12'>
            ...
            <p className='text-gray-600'>
              ...
              aquellas finalidades que no son necesarias para el cumplimiento de las obligaciones derivadas de la contratación de productos
              y servicios bancarios y financieros.
            </p>
          </section>
          <section className='mb-12'>
            <h2 className='text-2xl font-bold text-primary mb-4'>5. Limitación del uso o divulgación</h2>
